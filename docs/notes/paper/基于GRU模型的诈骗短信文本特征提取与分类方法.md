...
<!-- 图片缺失: ../../article/assets/fraud分类实验/file-20250603221903428.png -->
<!-- 图1：基于GRU的诈骗文本分类模型架构 -->
...
图2展示了模型在测试集上的混淆矩阵：
<!-- 图片缺失: ../../article/assets/fraud分类实验/file-20250603221615063.png -->
...
<!-- 图片缺失: ../../article/assets/fraud分类实验/file-20250603221718023.png -->
...
<!-- 图片缺失: ../../article/assets/fraud分类实验/file-20250603221727981.png -->
图4：GRU模型训练过程中的准确率变化
