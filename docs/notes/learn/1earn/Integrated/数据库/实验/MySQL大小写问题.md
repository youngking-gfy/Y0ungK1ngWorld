...
新建一个表 test1 ,字段 text,大 A 小 a 2 个数据,默认字符集
...
再新建一个表 test2 ,字段 text,大 A 小 a 2 个数据,字符集 utf8_bin
...
- [Mysql 查询英文如何严格区分大小写？](http://www.imooc.com/article/14190)
