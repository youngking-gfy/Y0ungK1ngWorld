...
- [实录 | ThreatSource 鸟哥：浅谈云安全技术以及安全架构亮点](https://mp.weixin.qq.com/s/tLHroy8yZIsZCjfdKLK-wQ)
...
- [谷歌云 Compute Engine 攻防](https://mp.weixin.qq.com/s/GsgD-rIQqGdv2cGslsYrDw)
...
- [wyzxxz/aksk_tool](https://github.com/wyzxxz/aksk_tool) - AK 资源管理工具，阿里云/腾讯云 AccessKey AccessKeySecret，利用 AK 获取资源信息和操作资源，ECS/CVM 操作/执行命令，OSS/COS 管理，RDS 管理，域名管理，添加 RAM 账号等
  ```bash
...
- [云主机 AK/SK 泄露利用](https://mp.weixin.qq.com/s/4wpqjjvcT9YjmZOJGB4lJw)
- [由 access key 泄露浅谈云安全](https://www.freebuf.com/articles/web/287512.html)
- [记一次阿里云主机泄露 Access Key 到 Getshell](https://www.freebuf.com/articles/web/255717.html)
...
- [【云安全】阿里云 OSS 对象存储攻防](https://mp.weixin.qq.com/s/rIRYE0yTHfxWkCi5IBQxMw)
- [使用阿里云 OSS 可能存在的两个安全风险](https://mp.weixin.qq.com/s/0PidovG8aqaaR-G7zyJs_Q)

**案例**

- [阿里云 oss key 利用](http://r3start.net/index.php/2019/09/16/580)
...
- [BishopFox/smogcloud](https://github.com/BishopFox/smogcloud) - 查找拥有的暴露的 AWS 云资产
...
- [使用 Python 批量扫描 Amazon S3 Bucket 配置问题](https://www.freebuf.com/column/229760.html)
...
- [Azure 攻击路径](https://mp.weixin.qq.com/s/p_7wAKpYUGk5Sg09pHibLQ)
...
- [如何利用 Azure 获取活动目录信息](https://www.anquanke.com/post/id/158926)
...
- [【云安全】腾讯云 COS 对象存储攻防](https://mp.weixin.qq.com/s/CyyH7rIJTfMa0V8m4murqw)
...
- [曾垚（火线安全）-Serverless 应用安全浅谈](https://mp.weixin.qq.com/s/6liTZakSiCeam-bOOvq5Xg)
