...
- [Oracle 数据库注入笔记](../Web安全/Web_Generic/SQLi.md#Oracle)
...
- 相关文章
  ...
  - [ORACLE TNS Listener 远程注册投毒（Poison Attack）漏洞](https://blog.csdn.net/wengtf/article/details/46632405)
