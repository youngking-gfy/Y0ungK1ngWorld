---
title: bypass_disable_function
createTime: 2024/10/16 20:20:40
permalink: /learn/wj2i6wzj/
---
...
Fastcgi 是一种通讯协议，用于 Web 服务器与后端语言的数据交换。
...
其中使用了%09 来绕过空格，以 base64 的形式来执行我们的命令
