...
- [php 中函数禁用绕过的原理与利用](https://mp.weixin.qq.com/s/_L379eq0kufu3CCHN1DdkA)

**相关工具**

- [proudwind/phpinfo_scanner](https://github.com/proudwind/phpinfo_scanner) - 抓取 phpinfo 重要信息 - 我这里运行报错,解决方法是把 15 行的 3 个 nth-child 改为 nth-of-type

---

## 版本号

最直观的就是 php 版本号（虽然版本号有时候会在响应头中出现）
...
如一些 ctf 题会把 disable 设置的极其恶心，这里要使用一些 bypass 的技巧
...
如果使用了 opcache，那么可能达成 getshell，但需要存在文件上传的点
