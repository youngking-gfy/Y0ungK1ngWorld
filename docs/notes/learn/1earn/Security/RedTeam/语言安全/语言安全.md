...
- [Go 和 Python 的源码安全保护](https://ichxxx.cn/2021/01/06/code_protection_in_go_and_python/)
...
- [Powershell 样本分析](../../BlueTeam/分析.md#powershell)
...
- [shell 编程](../../../Integrated/Linux/笔记/shell编程.md)
...
- [Shell 样本分析](../../BlueTeam/分析.md#linux)
...
- [Cocos2dlua 手游 Lua 解密与资源解密实战](https://bbs.pediy.com/thread-268574.htm)
...
- [Nim 语言在蓝军实战中的研究总结](https://mp.weixin.qq.com/s/cVxbbY98irN-9vZQNDJczQ)
