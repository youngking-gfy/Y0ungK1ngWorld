...
- [初探 Python 沙箱逃逸](https://qianfei11.github.io/2020/04/02/%E5%88%9D%E6%8E%A2Python%E6%B2%99%E7%AE%B1%E9%80%83%E9%80%B8/)
- [IS-pwn-escape-python 沙箱逃逸](https://hitworld.github.io/posts/8722019b/)
...
在 PEP 498(python > 3.6.0)中引入了新的字符串类型修饰符:f 或 F,用 f 修饰的字符串将可以执行代码.可以理解为字符串外层套了一个 exec().
...
python 存在一些内置函数(即默认已经导入的函数),对应的内置模块**builtins**.
