...
- [某 java 客服系统后续代码审计](https://mp.weixin.qq.com/s/Alj6MQmJv9ekGzcUNiIdeg)
...
- [r00tSe7en/JNDIMonitor/](https://github.com/r00tSe7en/JNDIMonitor/) - 一个 LDAP 请求监听器，摆脱 dnslog 平台
- [wyzxxz/jndi_tool](https://github.com/wyzxxz/jndi_tool) - JNDI 服务利用工具 RMI/LDAP，支持部分场景回显、内存 shell，高版本 JDK 场景下利用等，fastjson rce 命令执行，log4j rce 命令执行 漏洞检测辅助工具
...
- [fnmsd/MySQL_Fake_Server](https://github.com/fnmsd/MySQL_Fake_Server) - 用于渗透测试过程中的假 MySQL 服务器，纯原生 python3 实现，不依赖其它包。
