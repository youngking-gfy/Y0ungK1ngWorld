...
- [sliver c2 代码的学习](https://x.hacking8.com/post-445.html)
...
sliver 自 1.5 版本开始,支持 2 种操作模式 `Session Mode`/`Beacon Mode`
...
当有主机上线后,控制台会有 log 提示,我们可以运行 `sessions` 查看可控制的机器列表
