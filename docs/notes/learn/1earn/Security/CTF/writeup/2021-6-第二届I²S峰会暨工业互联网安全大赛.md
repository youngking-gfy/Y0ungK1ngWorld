---
title: 2021-6-第二届I²S峰会暨工业互联网安全大赛
createTime: 2024/10/16 20:20:39
permalink: /learn/gwci6q73/
---
...
安装 力控科技监控组态软件 ForceControl V7.0
...
改自身 host 文件，将 chall.pwnable.tw 解析到自己 127.0.0.1
...
操作数据库失败 XPATH syntax error: '~bees_admin,bees_admin_group,bee'
...
目标为 xp,存在 17-010 回弹失败,尝试用 msf 的 ms17_010_command 直接执行命令
...
登陆后查看管理员最近使用的文件, c:\PS6900\Opnote\操作票 里面有 flag
