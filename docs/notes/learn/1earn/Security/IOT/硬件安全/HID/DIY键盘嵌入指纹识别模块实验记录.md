---
title: DIY键盘嵌入指纹识别模块实验记录
createTime: 2024/10/16 20:20:39
permalink: /learn/yovccfbu/
---
...
1. 首先不得不吐槽一波：Arduino pro mini 这个型号的开发板，小组采购的第一块 pro mini 到货以后，拆开包装拿来烧录程序，
   ...
   直到我翻看买家评论，有位大哥说自己买了 3 块只有一块是好的，想到会不会是只买了一块正好中奖拿了块坏掉的，我当即另外找了 3 家店铺下单各买了一块 pro mini。
...
2. 还有就是国内某些无良作坊，数据线不按照标准生产，竟然把表示电源正负极颜色的线胡乱接，完全违背 "红正黑负" 的基本电气常识，导致后期直接将 USB HUB 直接烧毁。
   ...
   当时通电测试之前没考虑过这一项，因为觉得 20 块的扩展线而已，又没有什么技术含量，结果哪知道还真有憨批厂商连颜色都不按标准来！
...
后期无论我们等待多久、如何尝试改变手指触碰角度和方向、换接黄绿线、调整电压、重布线、转接 TTL……永远都卡在了"录入指纹成功"的这一步上。
