...
- [binwalk 提取固件失败](https://my.oschina.net/u/4581876/blog/4380942) - 在 binwalk 遇到大端序可以先用 DD 截取出来之后使用 objcopy 转换为小端序再用 binwalk 提取。
...
- [路由器逆向分析------firmware-mod-kit 工具安装和使用说明](https://blog.csdn.net/QQ1084283172/article/details/68061957)
...
- [挂载(mount)jffs2 格式镜像文件到宿主 linux](http://zhuqingcode.github.io/linux/2014/01/09/mount-jffs2-pc.html)
- [jffs2 文件系统的打开、创建与使用](https://blog.csdn.net/feitingfj/article/details/120530997)
- [挂载(mount)jffs2 格式镜像文件到宿主 linux](https://github.com/zhuqingcode/zhuqingcode.github.com/blob/fee936718b81d3efe994d4f46d9850353175c6d9/_posts/2014-01-09-mount-jffs2-pc.md)
...
- [【技术分享】Dlink DWR-932B 路由器被爆多个安全漏洞](https://www.anquanke.com/post/id/84671) - 上面文章的翻译
...
- [Dlink_DWR-932B 路由器固件分析](./实验/Dlink_DWR-932B路由器固件分析.md)
